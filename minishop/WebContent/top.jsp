...
<body>
	<div style="margin-left: auto;margin-right: auto;width: 800px;">
		<h1 style="float: left; font:40px Georgia Bold,sans-serif;text-align: center;color: #fff;text-shadow: 0px 3px 8px #2a2a2a;">자바나라 쇼핑몰</h1>
		...
		<div>
			<ul class="lavaLampNoImage" id="menu">
				<li class="current"><a href="/minishop/prdlist.do">Home</a></li>
